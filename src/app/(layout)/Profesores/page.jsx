   ...
   async function handlerFetch(limit, page) {
     ...
     const res = await fetch(
       window?.location?.href?.includes("localhost")
         ? `http://localhost:5002/api/user?limit=${finalLimit}&page=${finalPage}&rol=PROFESOR`
         : ``
     );
   ...
   return (
     <div className="h-[80vh] flex items-center justify-center">
       <div className="max-w-4xl w-full bg-white rounded-lg shadow-md p-8 border border-gray-200">
         <h1 className="text-3xl text-center mb-8 text-gray-900">Profesores</h1>
         ...
         <div className="flex flex-col items-center mb-4 w-full">
           <h2 className="text-lg text-gray-900 mb-2">Profesores registrados</h2>
