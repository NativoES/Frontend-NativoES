...
const Textarea = (
  ({ label, error, fullWidth = false, className = '', ...props }, ref) => {
    const baseClasses = 'rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 text-gray-900 dark:text-gray-900 bg-white dark:bg-gray-50 dark:border-gray-700';
