    ...
    return (
        <div className="relative z-0 w-full  group ">
            <input
                ...
                disabled={disabled}
                // style={{fontSize: '16px'}}
                className={`block min-w-[200px] text-[16px] md:text-[12px] ${shadow ? shadow : 'shadow-[#b6b6b6]'} bg-white   py-2.5  w-full text-[16px] text-gray-900 bg-transparent  px-5 appearance-none   focus:ring-0  peer rounded-[5px] ${table ? 'focus:outline-yellow' : 'focus:outline-none border border-[#cfcfcf] '}`} />
